            ...
            <div class="card-body">
                <form action="{{ route('mahasiswa.store') }}" method="post">
                    ...
                    <div class="from-group mb-3">
                        ...
                        <input type="text" name="nim" class="@error('nim') is-invalid @enderror from-control" value="{{ old('nim') }}" required >
                        @error('nim')
                            <div class="mt-1">
                    ...
                    <div class="from-group mb-3">
                        ...
                        <textarea name="alamat" class="from-control" >{{ old('alamat') }}</textarea>
                    </div>
